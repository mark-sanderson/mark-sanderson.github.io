...
pdfurl: '/files/papers/Evaluation_of_herd_behavior_caused_by__population_scale_concept_drift.pdf'
...
---
[Official paper copy](https://doi.org/10.1145/3477495.3531792){:target="_blank"}

[Download local PDF](/files/papers/Evaluation_of_herd_behavior_caused_by__population_scale_concept_drift.pdf){:target="_blank"}
